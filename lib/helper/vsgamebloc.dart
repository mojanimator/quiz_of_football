...
class WallpaperBloc implements BlocBase {
  ...
  final _wallpaperStreamController = BehaviorSubject<List<VSGame>>();
...
//  final _wallpaperStreamController = StreamController<List<Wallpaper>>();
  ...
  Sink<List<VSGame>> get sink => _wallpaperStreamController.sink;

  Stream<List<VSGame>> get stream => _wallpaperStreamController.stream;
